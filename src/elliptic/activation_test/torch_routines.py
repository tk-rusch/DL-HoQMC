...
def train(lr,reg,width,depth,N,max_epochs,id):
    ...
    model = get_neural_network(layer_sizes, nn.ReLU)
    ...
    Path('new_results_relu').mkdir(parents=True, exist_ok=True)
    with open('new_results_relu/N_'+str(int(N))+'.txt','a') as file:
